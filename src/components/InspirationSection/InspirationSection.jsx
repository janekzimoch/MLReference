  ...
  return (
    <div className="pt-[250px]">
      <div className="grid grid-cols-12 grid-rows-12 px-8 w-full h-full drop-shadow-2xl rounded-3xl">
        <div className="relative col-span-6 col-start-1 2xl:col-span-5 2xl:col-start-2 row-start-0 row-span-3 rounded-2xl p-10 m-5">
          <h1 className="z-40 text-center font-light w-full text-light-gray text-5xl py-1 drop-shadow-sm">
            How do you keep up?
          </h1>
          <Blob1 />
        </div>
        <div className="relative col-span-8 2xl:col-span-6 font-light col-start-7 2xl:col-start-8 row-start-3 row-span-4 m-5  mb-30 p-10">
        ...
        <div className="relative col-span-12 col-start-1 2xl:col-span-10 2xl:col-start-2 row-start-8 row-span-2 m-5 mt-20 p-10">
